...
1. Login to your Onyx deployment (create an account first).
   <div style={{ display: "flex", justifyContent: "center" }}>
     <img src="/images/onyx-login.png" alt="Onyx Login Page" width="75%" />
   </div>
2. In the set-up process select `Ollama` as the LLM provider.
   <div style={{ display: "flex", justifyContent: "center" }}>
     <img src="/images/onyx-ollama-llm.png" alt="Onyx Set Up Form" width="75%" />
   </div>
3. Provide your **Ollama API URL** and select your models.
   ...
   <div style={{ display: "flex", justifyContent: "center" }}>
     <img src="/images/onyx-ollama-form.png" alt="Selecting Ollama Models" width="75%" />
   </div>
...
<div style={{ display: "flex", justifyContent: "center" }}>
  <img src="/images/onyx-query.png" alt="Onyx Query Example" width="75%" />
</div>
